...
class Config::Sources::YAMLSource
  ...
  # source://caco/0.1.0/lib/caco/settings_loader_monkeypatch.rb#21
  def decrypt_content(content); end
  ...
  #
  # source://caco/0.1.0/lib/caco/settings_loader_monkeypatch.rb#4
  def load; end
